...
the likelihood framework. It is designed to be dependency-free with respect to
the firecrown.likelihood package to avoid circular import issues.

Classes moved from:
- likelihood/_base.py: Likelihood, NamedParameters, Statistic, Source, Tracer, etc.
"""
