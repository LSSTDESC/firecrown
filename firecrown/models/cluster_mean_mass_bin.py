...
class ClusterMeanMass():
    ...
    def __init__(
        ...
        self.cluster_abundance_bin = ClusterAbundanceBinned(cluster_mass, cluster_redshift, sky_area)
        self.bin_funcs = self._cluster_mean_mass_bin_funcs()
        self.info = None


    def _cluster_mean_mass_z_intp_logM_intp_bin_d2logM(self, ccl_cosmo, logM: float, z: float, logM_obs_lower, logM_obs_upper, z_obs_lower, z_obs_upper):
    ...
    def _cluster_mean_mass_z_intp_logM_intp_bin_d2logM_integrand(self, logM: float, z: float):
        ...
        return self._cluster_mean_mass_z_intp_logM_intp_bin_d2logM(ccl_cosmo, logM, z, logM_obs_lower, logM_obs_upper, z_obs_lower, z_obs_upper)


    def _cluster_mean_mass_z_intp_logM_intp_bin_logM(self, ccl_cosmo, logM_obs_lower, logM_obs_upper, z_obs_lower, z_obs_upper):
        """Integral of integrand when we have the two proxies redshift and mass"""

        self.info = ClusterMeanMassInfo(ccl_cosmo, logM_obs_lower=logM_obs_lower, logM_obs_upper=logM_obs_upper, z_obs_lower=z_obs_lower, z_obs_upper=z_obs_upper)
        ...
        N = self.cluster_abundance_bin.compute_bin_N(ccl_cosmo, logM_obs_lower, logM_obs_upper, z_obs_lower, z_obs_upper)
        return logM * DeltaOmega / N



    def _cluster_mean_mass_z_intp_bin_d2logM(self, ccl_cosmo, logM: float, z: float, z_obs_lower, z_obs_upper):
    ...
    def _cluster_mean_mass_z_intp_bin_d2logM_integrand(self, logM: float, z: float):
        ...
        return self._cluster_mean_mass_z_intp_bin_d2logM(ccl_cosmo, logM, z, z_obs_lower, z_obs_upper)


    def _cluster_mean_mass_z_intp_bin_logM(self, ccl_cosmo, logM_lower, logM_upper, z_obs_lower, z_obs_upper):
        """Integral of integrand when we have the two proxies redshift and mass"""

        self.info = ClusterMeanMassInfo(ccl_cosmo, z_obs_lower=z_obs_lower, z_obs_upper=z_obs_upper)
        ...
        N = self.cluster_abundance_bin.compute_bin_N(ccl_cosmo, logM_lower, logM_upper, z_obs_lower, z_obs_upper)

        return logM * DeltaOmega / N


    def _cluster_mean_mass_logM_intp_bin_d2logM(self, ccl_cosmo, logM: float, z: float, logM_obs_lower, logM_obs_upper):
    ...
    def _cluster_mean_mass_logM_intp_bin_d2logM_integrand(self, logM: float, z: float):
        ...
        return self._cluster_mean_mass_logM_intp_bin_d2logM(ccl_cosmo, logM, z, logM_obs_lower, logM_obs_upper)

    def _cluster_mean_mass_logM_intp_bin_logM(self, ccl_cosmo, logM_obs_lower, logM_obs_upper, z_lower, z_upper):
        """Integral of integrand when we have the two proxies redshift and mass"""

        self.info = ClusterMeanMassInfo(ccl_cosmo, logM_obs_lower=logM_obs_lower, logM_obs_upper=logM_obs_upper)
        ...
        N = self.cluster_abundance_bin.compute_bin_N(ccl_cosmo, logM_obs_lower, logM_obs_upper, z_lower, z_upper)
    ...
    def _cluster_mean_mass_bin_logM(self, ccl_cosmo, logM_lower, logM_upper, z_lower, z_upper):
    #calls the above with logM_obs and z
        ...
        N = self.cluster_abundance_bin.compute_bin_N(ccl_cosmo, logM_lower, logM_upper, z_lower, z_upper)
    ...
    def _cluster_mean_mass_bin_funcs(self):
        if self.cluster_m.use_proxy == False:
            ...
            if self.cluster_z.use_proxy == False:
                ...
                self._compute_intp_bin_d2logM = self._cluster_mean_mass_logM_intp_bin_d2logM
            else:
                self._compute_bin_logM = self._cluster_mean_mass_z_intp_logM_intp_bin_logM
                self._compute_intp_bin_d2logM = self._cluster_mean_mass_z_intp_logM_intp_bin_d2logM
        return True


    def compute_bin_logM(self, ccl_cosmo, logM_obs_lower, logM_obs_upper, z_obs_lower, z_obs_upper):
        return self._compute_bin_logM(ccl_cosmo, logM_obs_lower, logM_obs_upper, z_obs_lower, z_obs_upper)
