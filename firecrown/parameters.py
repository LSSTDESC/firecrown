...
class DerivedParameterScalar:
    ...
    def __init__(self, section: str, name: str, val: float):
        """Initialize the DerivedParameterScalar object."""
...
class DerivedParameterCollection:
    ...
    def __init__(self, derived_parameters: Sequence[DerivedParameterScalar]):
        """Construct an instance from a sequence of DerivedParameter objects."""

        if not all(isinstance(x, DerivedParameterScalar) for x in derived_parameters):
            raise TypeError(
                "DerivedParameterCollection expects a list of DerivedParameterScalar"
                "but received a " + str([str(type(x)) for x in derived_parameters])
            )

        self.derived_parameters: Dict[str, DerivedParameterScalar] = {}
    ...
    def add_required_parameter(self, derived_parameter: DerivedParameterScalar):
    ...
    def get_derived_list(self) -> List[DerivedParameterScalar]:
        """Implement lazy iteration through the contained parameter names."""
