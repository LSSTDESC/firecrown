...
def initialize_objects():
    ...
    return [cluster_mass, cluster_z, cluster_mass_proxy, cluster_abundance, cluster_abundance_Mproxy]


def test_initialize_objects():
    
    cluster_mass, cluster_z, cluster_mass_proxy, cluster_abundance, cluster_abundance_Mproxy = initialize_objects()
...
def test_cluster_abundance_functions():
    ...
    d2n_logM_p_bin = cluster_abundance_Mproxy.compute_intp_bin_d2n(ccl_cosmo, logM, z, logM_obs_lower=logM_obs_lower, logM_obs_upper=logM_obs_upper)
    assert(type(d2n_logM_p_bin) != 0.0)
