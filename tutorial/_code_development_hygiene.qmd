...
They help in the automatic generation of documentation, and when used with a static type checker they help make sure the type information in the documentation does not diverge from the code itself.
...
We use `ty`[^ty] as our static type checking tool.

[^ty]: Ty is a static type checker for Python.
  Documentation for it is available at [https://docs.astral.sh/ty](https://docs.astral.sh/ty).
