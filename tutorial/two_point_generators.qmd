...
import numpy as np
from firecrown.metadata_functions import make_all_photoz_bin_combinations, TwoPointCells
...
```{python}
all_two_point_functions = tp.TwoPoint.from_metadata_harmonic(
...
The parameters necessary in our analysis depend on the two-point statistic measurements and the systematics we are considering.
