...
zdist_y1_lens = ZDistLSSTSRD.year_1_lens()
zdist_y10_lens = ZDistLSSTSRD.year_10_lens()

zdist_y1_source = ZDistLSSTSRD.year_1_source()
...
Here we show the first bin for the lens and source samples for both Year 1 and Year 10, the functions are evaluated at $100$ points equally spaced between $0$ and $1.0$.[^3]
