...
The lens and source redshift bin collections used for the computations are imported from the `firecrown.generators` module: [[generators|LSST_Y1_LENS_HARMONIC_BIN_COLLECTION]] and [[generators|LSST_Y1_SOURCE_HARMONIC_BIN_COLLECTION]].
