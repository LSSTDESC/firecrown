...
subtitle: "Version `{python} import sys; from pathlib import Path; sys.path.insert(0, str(Path.cwd().parent)); from firecrown.version import __version__; print(__version__, end='')`"
authors:
  - Marc Paterno
  - Sandro Vitenti
format:
...
-   We are using type hints and `ty` to help catch type-related errors.
