...
For CMB lensing convergence, Firecrown also provides the [[metadata_types|CMBLensing]] projected-field descriptor.
This plays the same metadata role as a bin descriptor in two-point construction, but it represents the CMB lensing convergence field rather than a galaxy redshift distribution.
When such metadata are passed to [[likelihood|TwoPointFactory]], [[metadata_types|CMB.CONVERGENCE]] measurements are handled through [[likelihood|CMBConvergenceFactory]].
