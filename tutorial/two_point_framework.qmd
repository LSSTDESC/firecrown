...
In harmonic space, the measurement is characterized by a set of multipole orders ($\ells$) at which the multipole moments ($C_\ell$) of the measured quantity are calculated.
