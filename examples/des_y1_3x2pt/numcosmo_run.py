...
mb.add_sparam(r'ia_\mathrm{bias}', 'ia_bias', -5.0, 5.0, 0.1, 0.0, 0.5, Ncm.ParamType.FREE)
...
mb.add_sparam(r'src0_delta_z', "src0_delta_z", -0.16, +0.16, 0.001, 0.0, -0.001, Ncm.ParamType.FREE)
mb.add_sparam(r'src1_delta_z', "src1_delta_z", -0.13, +0.13, 0.001, 0.0, -0.019, Ncm.ParamType.FREE)
mb.add_sparam(r'src2_delta_z', "src2_delta_z", -0.11, +0.11, 0.001, 0.0, +0.009, Ncm.ParamType.FREE)
mb.add_sparam(r'src3_delta_z', "src3_delta_z", -0.22, +0.22, 0.001, 0.0, -0.018, Ncm.ParamType.FREE)

mb.add_sparam(r'lens0_delta_z', "lens0_delta_z", -0.1, +0.1, 0.001, 0.0, +0.001, Ncm.ParamType.FREE)
mb.add_sparam(r'lens1_delta_z', "lens1_delta_z", -0.1, +0.1, 0.001, 0.0, +0.002, Ncm.ParamType.FREE)
mb.add_sparam(r'lens2_delta_z', "lens2_delta_z", -0.1, +0.1, 0.001, 0.0, +0.001, Ncm.ParamType.FREE)
mb.add_sparam(r'lens3_delta_z', "lens3_delta_z", -0.1, +0.1, 0.001, 0.0, +0.003, Ncm.ParamType.FREE)
mb.add_sparam(r'lens4_delta_z', "lens4_delta_z", -0.1, +0.1, 0.001, 0.0, +0.000, Ncm.ParamType.FREE)

mb.add_sparam(r'src0_mult_bias', "src0_mult_bias", -0.23, +0.23, 0.001, 0.0, +0.000, Ncm.ParamType.FREE)
mb.add_sparam(r'src1_mult_bias', "src1_mult_bias", -0.23, +0.23, 0.001, 0.0, +0.000, Ncm.ParamType.FREE)
mb.add_sparam(r'src2_mult_bias', "src2_mult_bias", -0.23, +0.23, 0.001, 0.0, +0.000, Ncm.ParamType.FREE)
mb.add_sparam(r'src3_mult_bias', "src3_mult_bias", -0.23, +0.23, 0.001, 0.0, +0.000, Ncm.ParamType.FREE)
...
map_cosmo = MappingNumCosmo(require_nonlinear_pk=True,
                            p_ml=ps_ml, p_mnl=ps_mnl, dist=dist)
