...
context = {
    "downloads": [
        ("pdf", "//firecrown.readthedocs.io/_/downloads/en/latest/pdf/"),
        ("html", "//firecrown.readthedocs.io/_/downloads/en/latest/htmlzip/"),
        ("epub", "//firecrown.readthedocs.io/_/downloads/en/latest/epub/"),
    ]
}
